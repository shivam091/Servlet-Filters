...
import org.servlet.filters.Servlets.ByteArrayRequestWrapper;
 ...
 *
 * <p>
 * NOTE: This is a modified version of the RequestDumperFilter that is
...
public final class RequestDumperFilter implements Filter {
	...
	public void doFilter(final ServletRequest request,
		...
		if (request instanceof HttpServletRequest) {
			...
			final ByteArrayRequestWrapper wrappedRequest = new ByteArrayRequestWrapper(
					hrequest);
